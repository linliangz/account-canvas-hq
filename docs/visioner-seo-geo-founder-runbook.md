...
1. Verify the `visioner.cc` Domain Property in Google Search Console with a DNS TXT record.
2. Submit `https://www.visioner.cc/sitemap.xml` and record the accepted URL count.
